...
using Tyuiu.DudkovIE.Sprint4.Task4.V10.Lib;
namespace Tyuiu.DudkovIE.Sprint4.Task4.V10
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* Дан двумерный массив заполенный статическими значениями от 1 до 7, нечетный элемент массива заменить на 0*");
            Console.WriteLine("*                                                                         *");
            Console.WriteLine("*                                                                         *");
            Console.WriteLine("***************************************************************************");
