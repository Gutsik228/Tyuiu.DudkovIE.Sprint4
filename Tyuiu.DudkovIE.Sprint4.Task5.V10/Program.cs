...
using Tyuiu.DudkovIE.Sprint4.Task5.V10.Lib;
namespace Tyuiu.DudkovIE.Sprint4.Task5.V10
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* Дан двумерный целочисленный массив 5 на 5 элементов, заполненный случайными значениями в диапазоне от -4 до 7. Найти сумму положительных элементов*");
            Console.WriteLine("*                                                                         *");
            Console.WriteLine("*                                                                         *");
            Console.WriteLine("***************************************************************************");
